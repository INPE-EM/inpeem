...
System::Void INPEEM::AboutForm::AboutForm_Load(System::Object ^ sender, System::EventArgs ^ e)
{
	if (lLanguage == "en") {
		this->Text = "About";
		lProgram->Text = "INPE-EM LUCC Model Manager";
		lCompatible->Text = "Compatible with INPE-EM LUCC 1.0";
		lVersion->Text = "Version 1.0";
		lCopyright->Text = "Copyright © 2018. All rigths reserved.";
	}
	else {
		this->Text = "Sobre";
		lProgram->Text = "Gerenciador de Modelos INPE-EM LUCC";
		lCompatible->Text = "Compatível com INPE-EM LUCC 1.0";
