...
function componentSV_execute(year, model)
	...
	for i, cell in pairs (model.cs.cells) do
		...
		if (model.save == true) then
			...
			-- Added NET
			cell[model.componentSV.net..year] = (((cell.D_Area * cell.B_AGB) * (1 - cell.VR_AGBPercAGB)) + ((cell.D_Area * cell.B_AGB) * cell.B_BGBPercAGB * (1 - cell.VR_BGBPercBGB)) + ((cell.D_Area * cell.B_AGB) * cell.B_LitterPercAGB)) * cell.B_FactorB_CO2_fire -- VR 1st Order
			cell[model.componentSV.net..year] = cell[model.componentSV.net..year] + (cell.biomass_lost * cell.B_FactorB_CO2_fire) -- SV emission
			cell[model.componentSV.net..year] = cell[model.componentSV.net..year] - (cell.biomass_acc * cell.B_FactorB_CO2) 	  -- SV absortion
			remaining_forest_area = model.cs.cellarea - (cell.D_AreaAcc - cell.D_Area)
			cell[model.componentSV.net..year] = cell[model.componentSV.net..year] + (((cell.B_ActualAGB * cell.DEGRAD_Degrad * cell.DEGRAD_AGB_loss) + (cell.B_ActualAGB * cell.DEGRAD_Degrad * cell.DEGRAD_BGB_loss * cell.B_BGBPercAGB) + (cell.B_ActualAGB * cell.DEGRAD_Degrad * cell.DEGRAD_Litter_loss * cell.B_LitterPercAGB) + (cell.B_ActualAGB * cell.DEGRAD_Degrad * cell.DEGRAD_DeadWood_loss * cell.B_DeadWoodPercAGB)) * cell.B_FactorB_CO2_fire) -- Degrad emission
			cell[model.componentSV.net..year] = cell[model.componentSV.net..year] - (((cell.AGBRegrowRate * remaining_forest_area) + (cell.AGBRegrowRate * cell.B_BGBPercAGB * remaining_forest_area)) * cell.B_FactorB_CO2)		-- Degrad absortion
			cell[model.componentSV.net..year] = math.floor(cell[model.componentSV.net..year])
		end
...
function componentSV_init(model)
	...
	model.componentSV.net = model.componentSV.name.."Net" -- Added NET
	...
	if (model.save == true) then 
		for year = model.yearInit, model.yearFinal, 1 do 
			...
			model.componentSV.saveCount = model.componentSV.saveCount + 1
			model.componentSV.saveAttrs[model.componentSV.saveCount] = model.componentSV.net..year -- Added NET
		end
	end	 
